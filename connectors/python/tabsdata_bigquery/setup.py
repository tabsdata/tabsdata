...
with global_spinner("Building package 'tabsdata-bigquery' (BigQuery Connector)..."):
    setup(
        name="tabsdata_bigquery",
        version=read(
            os.path.join(
                "tabsdata_bigquery",
                "assets",
        ...
        description="Tabsdata plugin to access BigQuery data.",
        ...
        packages=find_packages(
            ...
            exclude=[
                "tests",
                "tests*",
                "tests_tabsdata_bigquery",
                "tests_tabsdata_bigquery*",
            ],
        ),
        package_dir={
            "tabsdata_bigquery": "tabsdata_bigquery",
        },
        package_data={
            "tabsdata_bigquery": [
                os.path.join(
