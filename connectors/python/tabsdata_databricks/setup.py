...
with global_spinner("Building package 'tabsdata-databricks' (Databricks Connector)..."):
    setup(
        name="tabsdata_databricks",
        version=read(
            os.path.join(
                "tabsdata_databricks",
                "assets",
        ...
        description="Tabsdata plugin to access Databricks data.",
        ...
        packages=find_packages(
            ...
            exclude=[
                "tests",
                "tests*",
                "tests_tabsdata_databricks",
                "tests_tabsdata_databricks*",
            ],
        ),
        package_dir={
            "tabsdata_databricks": "tabsdata_databricks",
        },
        package_data={
            "tabsdata_databricks": [
                os.path.join(
