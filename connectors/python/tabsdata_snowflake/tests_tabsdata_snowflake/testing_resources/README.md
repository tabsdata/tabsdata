...
```plaintext
    SNW__ACCOUNT=<SNOWFLAKE ACCOUNT>
    SNW__USER=DEV_CI_USER
    SNW__PAT=<PAT GENERATED IN THE PREVIOUS STEP>
    SNW__ROLE=DEV_CI_ROLE
    SNW__DATABASE=DEV_CI_DB
    SNW__SCHEMA=PUBLIC
    SNW__WAREHOUSE=COMPUTE_WH
```