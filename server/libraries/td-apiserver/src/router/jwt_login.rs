...
use td_objects::jwt::jwt_logic::{AccessRequest, RefreshRequest, TokenResponse};
...
router! {
    state => { Users },
    // state => { JwtState, UsersState, Roles },
...
pub async fn refresh(
    State(_users_state): State<Users>,
...
mod tests {
    ...
    // use crate::jwt::jwt_logic::tests::test_jwt_logic;
    // use td_schema;
    //  crate::routerusers::{PasswordHashingConfig, UsersLogic};
