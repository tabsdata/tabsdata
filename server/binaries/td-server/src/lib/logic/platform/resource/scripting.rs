...
impl ScriptBuilder {
    ...
    const FUNCTIONS: &'static str =
        include_str!("../../../../../resources/scripts/bash/functions.sh");
    #[cfg(windows)]
    const FUNCTIONS: &'static str =
        include_str!("../../../../../resources/scripts/cmd/functions.cmd");
    ...
    const TEARDOWN: &'static str =
        include_str!("../../../../../resources/scripts/bash/teardown.sh");
    #[cfg(windows)]
    const TEARDOWN: &'static str =
        include_str!("../../../../../resources/scripts/cmd/teardown.cmd");
...
mod tests {
    use super::*;
    use crate::logic::platform::resource::scripting::ArgumentPrefix::{Long, Short};
