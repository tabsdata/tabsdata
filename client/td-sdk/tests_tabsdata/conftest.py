...
class V2ExecutionContextFormat:
...
def v2_execution_context_format_representer(
    dumper: yaml.SafeDumper, v1_execution_context_format: V2ExecutionContextFormat
) -> yaml.nodes.MappingNode:
    """Represent a V2_yaml instance as a YAML mapping node."""
    ...
    return dumper.represent_mapping("!V2", v1_execution_context_format.content)
...
def get_dumper():
    ...
    safe_dumper.add_representer(
        V2ExecutionContextFormat, v2_execution_context_format_representer
    )
    return safe_dumper


def write_v2_yaml_file(
    filename: str,
    ...
    v1_execution_context = V2ExecutionContextFormat(content)
