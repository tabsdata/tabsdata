...
# In this example, we are obtaining the data from the file data.parquet and then
...
@td.publisher(
    td.LocalFileSource(os.path.join(ABSOLUTE_LOCATION, "data.parquet")),
    "output",
)
def input_file_parquet_string_format(df: td.TableFrame):
