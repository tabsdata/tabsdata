...
# In this example, we are obtaining the data from the file data.csv in Azure
...
# input data.
@td.publisher(
    name="test_input_gcs_csv",
    source=td.GCSSource("gs://BUCKET_NAME/testing_resources/data.csv", gcs_credentials),
    tables="output",
)
def input_gcs_csv(df: td.TableFrame):
