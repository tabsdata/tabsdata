...
from custom_output_plugin_multiple_outputs_with_none import CustomDestinationPlugin
...
@td.subscriber(
    name="output_plugin_multiple_outputs_with_none",
...
def output_plugin_multiple_outputs_with_none(df: td.TableFrame):
    df.drop_nulls()
    return None, None
