...
from tabsdata._secret import _recursively_load_secret
...
class AzureDestination(Output):
    ...
    def _to_dict(self) -> dict:
        ...
        return {
            self.IDENTIFIER: {
                self.FORMAT_KEY: self.format._to_dict(),
                self.URI_KEY: self._uri_list,
                self.CREDENTIALS_KEY: self.credentials._to_dict(),
            }
        }
    ...
    def _to_dict(self) -> dict:
        ...
        return {
            self.IDENTIFIER: {
                ...
                self.CATALOG_KEY: self.catalog._to_dict() if self.catalog else None,
            }
        }
