...
from tests.testing_resources.test_output_postgres_driver_provided.example import (
    output_postgres_driver_provided,
)
from tests.testing_resources.test_output_postgres_list.example import (
...
def test_output_postgres_list(tmp_path, testing_postgres):
    ...
    context_archive = create_bundle_archive(
        output_postgres_list, local_packages=ROOT_PROJECT_DIR, save_location=tmp_path
    )
