...
# In this example, we are obtaining the data from the file data.ndjson in Azure
...
# input data.
@td.publisher(
    td.AzureSource("az://tabsdataci/testing_resources/data.ndjson", azure_credentials),
    "output",
)
def input_azure_ndjson(df: td.TableFrame):
