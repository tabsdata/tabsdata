...
from tests.testing_resources.test_output_plugin.example import output_plugin
from tests.testing_resources.test_output_plugin_multiple_outputs.example import (
    output_plugin_multiple_outputs,
)
from tests.testing_resources.test_output_plugin_multiple_with_none.example import (
    output_plugin_multiple_outputs_with_none,
)
from tests.testing_resources.test_output_plugin_with_none.example import (
